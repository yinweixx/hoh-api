 ...
 */
@ThymesController(mapping = "/permissions")
public class PermissionsController implements ThymeleafController {
    private static final String TEMPLATE_PERMISSION = "/permissions";
    @Override
