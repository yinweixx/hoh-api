 ...
 */
@ThymesController(mapping = "/createReports")
public class CreateReportsController  implements ThymeleafController {
    private static final String TEMPLATE_CREATEREPORTS = "/createReports";
    @Override
    public String process(HttpServletRequest request, HttpServletResponse response, WebContext context) throws Exception {
        return TEMPLATE_CREATEREPORTS;
    }
}
